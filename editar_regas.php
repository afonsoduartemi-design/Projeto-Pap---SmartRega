...
$res_regas = $conn->query("SELECT p.*, COALESCE(u.nome_utilizador, 'Sistema') AS agendado_por FROM programacoes p LEFT JOIN users u ON p.id_utilizador = u.id_utilizador WHERE p.executado = 0 ORDER BY p.data_hora ASC");

$rega_id = isset($_GET['id']) ? (int)$_GET['id'] : null;
$rega = null;
$mensagem = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $rega_id) {
    ...
    if (!$scheduleStart) {
        ...
        // Ajuste quando o input não inclui segundos (Y-m-dTH:i). Se já passou
        // por alguns segundos, subimos para o minuto seguinte para evitar
        // falsos negativos na validação de passado.
        $now = new DateTime();
        ...
        if ($scheduleStart < $now) {
            ...
            if ($stmt->execute()) {
                ...
                header("Refresh: 2; url=editar_regas.php");
            } else {
...
<head>
    ...
    <title>Editar Rega — SmartRega</title>
...
<div class="admin-container">
    <div class="admin-header">
        <h2><i class="fas fa-edit"></i> Editar Regas Agendadas</h2>
        <p>Edita regas agendadas. Só é possível editar regas pendentes.</p>
    </div>
        ...
        <div class="account-card">
            <form method="POST" class="form-account">
                ...
                <div class="form-actions">
                    ...
                    <a href="editar_regas.php" class="btn-secondary"><i class="fas fa-arrow-left"></i> Voltar à Lista</a>
                </div>
            </form>
        </div>
    <?php else: ?>
        <!-- LISTA DE REGAS PENDENTES -->
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons-cell">
                                    <a href="editar_regas.php?id=<?php echo $row['id']; ?>" class="action-link edit-link">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" style="text-align:center; color:#bbb; padding:32px;">
